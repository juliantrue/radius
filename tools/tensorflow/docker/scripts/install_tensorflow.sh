...
wget https://storage.googleapis.com/tensorflow/linux/gpu/tensorflow_gpu-1.5.0-cp27-cp27m-linux_x86_64.whl

conda create -n tensorflow python=2.7 anaconda
source activate tensorflow
conda install -y -c menpo opencv3
pip install --ignore-installed --upgrade tensorflow_gpu-1.5.0-cp27-cp27m-linux_x86_64.whl
pip install plyfile
